...
• These commands can be used by any group member."""
    GREET_TXT ="""Here is the help for the <b>Greetings</b> module:
...
• /delall - delete the whole filters in a chat (chat owner only)."""
    NEWDATA_TXT = """𝖧𝖾𝗋𝖾 𝗂𝗌 𝗍𝗁𝖾 𝗌𝖾𝖼𝗈𝗇𝖽 𝗉𝖺𝗀𝖾 𝗈𝖿 𝗆𝗒 𝖧𝖾𝗅𝗉 𝖬𝗈𝖽𝗎𝗅𝖾.

𝑇𝑎𝑝 𝑂𝑛 𝐸𝑎𝑐𝒉 𝑀𝑜𝑑𝑢𝑙𝑒 𝑇𝑜 𝐺𝑒𝑡 𝐷𝑒𝑡𝑎𝑖𝑙𝑠 :✨"""
...
- Tiger Shroff support both url and alert inline buttons.
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/cinemaenglish123)</code>
