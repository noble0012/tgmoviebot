...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer(f"⚠️ Hey, {query.from_user.first_name}! 😁 𝗛𝗲𝘆 𝗙𝗿𝗶𝗲𝗻𝗱,𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗬𝗼𝘂𝗿𝘀𝗲𝗹𝗳.", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if not search:
        await query.answer(f"⚠️ Hey, {query.from_user.first_name}! 𝐋𝐢𝐧𝐤 𝐄𝐱𝐩𝐢𝐫𝐞𝐝 𝐊𝐢𝐧𝐝𝐥𝐲 𝐏𝐥𝐞𝐚𝐬𝐞 𝐒𝐞𝐚𝐫𝐜𝐡 𝐀𝐠𝐚𝐢𝐧 🙂.", show_alert=True)
        return
...
async def advantage_spoll_choker(bot, query):
    ...
    if files:
        ...
        k = await query.message.edit(f'⚠️ Hey, {query.from_user.first_name}! 𝚃𝙷𝙸𝚂 𝙼𝙾𝚅𝙸𝙴 I𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙾𝚁 𝙰𝙳𝙳𝙴𝙳 𝚃𝙾 𝙳𝙰𝚃𝚂𝙱𝙰𝚂𝙴💌')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('greet', callback_data='greet'),
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝐵𝑢𝑡𝑡𝑜𝑛𝑠 »', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
    ...
    elif query.data == "greet":
        buttons = [[
            InlineKeyboardButton('𝙱𝙰𝙲𝙺', callback_data='newdata')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=Script.GREET_TXT,
            disable_web_page_preview=True,
            reply_markup=reply_markup,
            parse_mode='html'
        )
        ...
        buttons = [[
            InlineKeyboardButton('𝑎𝑢𝑡𝑜', callback_data='autofilter'),
            InlineKeyboardButton('𝑚𝑎𝑛𝑢𝑒𝑙', callback_data='manualfilter')
            ],[
            InlineKeyboardButton('« 𝐵𝑎𝑐𝑘', callback_data='help'),
            InlineKeyboardButton('𝐶𝑙𝑜𝑠𝑒 ✗', callback_data='close_data')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('« 𝐵𝑎𝑐𝑘', callback_data='newdata')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('« 𝐵𝑎𝑐𝑘', callback_data='help'),
            InlineKeyboardButton('𝐿𝑎𝑛𝑔 𝐶𝑜𝑑𝑒𝑠', url='https://cloud.google.com/translate/docs/languages')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('« 𝐵𝑎𝑐𝑘', callback_data='about'),
            InlineKeyboardButton('𝑅𝑒𝑓𝑟𝑒𝑠𝒉 ⧖', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
